...
fn main() {
    ...
    // 0.999710
    let ampl: f64 = 0.025;
    let freq: f64 = 1.000136 * fdiff;
    let t: nd::Array1<f64>
        = nd::Array1::linspace(0.0, 400.0 / fdiff, 10000);
    //
    // 0.999407
    // let ampl: f64 = 0.05;
    // let freq: f64 = 0.999361 * fdiff;
    // let t: nd::Array1<f64>
    //     = nd::Array1::linspace(0.0, 200.0 / fdiff, 6000);
    //
    // 0.997759
    // let ampl: f64 = 0.1;
    // let freq: f64 = 0.997619 * fdiff;
    // let t: nd::Array1<f64>
    //     = nd::Array1::linspace(0.0, 100.0 / fdiff, 5000);
    //
    // 0.994671
    // let ampl: f64 = 0.15;
    // let freq: f64 = 0.995895 * fdiff;
    // let t: nd::Array1<f64>
    //     = nd::Array1::linspace(0.0, 75.0 / fdiff, 5000);
    //
    // 0.989239
    // let ampl: f64 = 0.20;
    // let freq: f64 = 0.993223 * fdiff;
    // let t: nd::Array1<f64>
    //     = nd::Array1::linspace(0.0, 50.0 / fdiff, 5000);
    //
    ...
    let vt: nd::Array2<f64>
        ...
        .flat_map(|ti| {
            x.iter().copied()
                .map(move |xj| {
                    a * (1.0 + ampl * (TAU * freq * ti).sin()) * xj.powi(4)
                })
        })
